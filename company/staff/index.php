...
<head>
<meta charset="utf-8">
<title>スタッフ一覧｜Beauty Scandal Pro</title>
...
<main>
	...
	<div class="row" id="m_title">
		<div class="col-8">
			<div class="heading1">スタッフ一覧<span> - 株式会社BeautyScandal</span></div>
		</div>
		<div class="col-4">
	...
	<div class="row">
		<div class="col-12">
			<div class="list_action">
				<div class="btn2 new"><a href="add.php">新規スタッフ登録</a></div>
			</div>
		</div>
		<div class="col-12">
			<div class="col_in">
				<div class="content">
					<table class="datatable">
						<thead>
							<tr>
								<td class="column-code"><a href="#" class="order-none">BSスタッフコード</a></td>
								<td class="column-title"><a href="#" class="order-des">スタッフ名</a></td>
								<td class="column-like"><a href="#" class="order-none">お気に入り数</a></td>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td class="column-title">
									<a href="view.php">山田 花子</a>
									<div class="column-info"><span>株式会社BeautyScandal</span><span>BeautyScandalSalon</span></div>
									<ul class="list_action">
										<li><a href="view.php">	スタッフ情報詳細</a></li>
										<li><a href="#" class="action_duplicate">複製</a></li>
										<li><a href="#" class="action_delete">削除</a></li>
									</ul>
								</td>
								<td class="column-like"><span class="material-icons">favorite</span>100</td>
							</tr>
							<tr>
								<td class="column-code">0000000000</td>
								<td class="column-title">
