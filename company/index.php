...
<head>
<meta charset="utf-8">
<title>企業一覧｜Beauty Scandal Pro</title>
	...
	<div class="row">
		<div class="col-12">
			<div class="list_action">
				<div class="btn2 new"><a href="search.php">新規企業登録</a></div>
			</div>
		</div>
		<div class="col-12">
			<div class="col_in">
				<div class="content">
					<table class="datatable">
						<thead>
							<tr>
								<td class="column-code"><a href="#" class="order-none">BS企業コード</a></td>
								<td class="column-title"><a href="#" class="order-des">企業名</a></td>
						...
						<tbody>
							<tr>
								...
								<td class="column-title">
									<a href="view.php">株式会社BeautyScandal</a>
									<div class="column-info"><span>代表名：木戸口 里砂</span></div>
									<ul class="list_action">
										<li><a href="view.php">企業情報詳細</a></li>
