...
<main>
	...
	<div class="row" id="m_title">
		<div class="col-12">
			<div class="heading1">従業員情報<span> - 田中 太郎</span></div>
		</div>
	</div>
	...
	<div class="row">
		<form class="form">
				...
				<div class="col_in">
					...
					<div class="content">
						...
						<dl>
							...
							<dd>
								<div class="form_block"><input type="text" name="" value="田中 太郎"></div>
							</dd>
						</dl>
						<dl>
						...
						<dl>
							<dt><p>従業員PASS</p></dt>
							<dd>
								<div class="form_block"><input type="text" name="" value="従業員Pass"></div>
							</dd>
						</dl>
					</div>
				</div>
			...
			<div class="col-12">
				<div class="col_in">
				<div class="heading2">「田中 太郎」を削除</div>
					<div class="content">
	...
	<div id="pan">
		<ul>
			...
			<li><a href="/agency/staff/view.php"><span>田中 太郎</span></a></li>
		</ul>
	</div>
</main>
