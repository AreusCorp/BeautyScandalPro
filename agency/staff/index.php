...
<head>
<meta charset="utf-8">
<title>従業員一覧｜Beauty Scandal Pro</title>
...
<main>
	...
	<div class="row" id="m_title">
		<div class="col-8">
			<div class="heading1">従業員一覧<span> - 株式会社代理店AAAAA</span></div>
		</div>
		<div class="col-4">
		...
		<div class="col-12">
			<div class="list_dev2">
				<ul class="btn2">
					...
					<li><a href="/agency/branch/">支店</a></li>
					<li><a href="/agency/staff/" class="active-tab">従業員</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-12">
			<div class="list_action">
				<div class="btn2 new"><a href="add.php">新規従業員登録</a></div>
			</div>
		</div>
		<div class="col-12">
			<div class="col_in">
				<div class="content">
					<table class="datatable">
						<thead>
							<tr>
								<td class="column-code"><a href="#" class="order-none">BS従業員コード</a></td>
								<td class="column-title"><a href="#" class="order-des">従業員名</a></td>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td class="column-title">
									<a href="view.php">田中 太郎</a>
									<div class="column-info"><span>新宿支店</span></div>
									<ul class="list_action">
										<li><a href="view.php">従業員情報詳細</a></li>
