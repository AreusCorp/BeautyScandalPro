...
<head>
<meta charset="utf-8">
<title>支店一覧｜Beauty Scandal Pro</title>
...
<main>
	...
	<div class="row" id="m_list">
		<div class="col-12">
			<div class="list_dev2">
				<ul class="btn2">
					<li><a href="/agency/view.php">代理店情報</a></li>
					<li><a href="/agency/branch/" class="active-tab">支店</a></li>
					<li><a href="/agency/staff/">従業員</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-12">
			<div class="list_action">
				<div class="btn2 new"><a href="add.php">新規支店登録</a></div>
			</div>
		</div>
		<div class="col-12">
			<div class="col_in">
				<div class="content">
					<table class="datatable">
						<thead>
							<tr>
								<td class="column-code"><a href="#" class="order-none">BS支店コード</a></td>
								<td class="column-title"><a href="#" class="order-des">支店名</a></td>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td class="column-title">
									<a href="view.php">新宿支店</a>
									<ul class="list_action">
										<li><a href="view.php">支店情報詳細</a></li>
	...
	<div id="pan">
		<ul>
			...
			<li><a href="/agency/branch/"><span>支店一覧</span></a></li>
		</ul>
	</div>
</main>
		...
		<div id="nav">
			<ul class="s_list">
				...
				<ul>
					...
					<ul>
						<li class="active"><a href="/agency/branch/">支店一覧</a></li>
