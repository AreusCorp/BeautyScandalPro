...
<head>
<meta charset="utf-8">
<title>支店情報｜Beauty Scandal Pro</title>
...
<main>
	...
	<div class="row" id="m_title">
		<div class="col-12">
			<div class="heading1">支店一覧<span> - 株式会社代理店AAAAA</span></div>
		</div>
	</div>
	...
	<div class="row" id="m_list">
		<div class="col-12">
			<div class="list_dev2">
				<ul class="btn2">
					<li><a href="/agency/view_forsalon.php">代理店情報</a></li>
					<li><a href="/agency/branch/index_forsalon.php" class="active-tab">支店</a></li>
				</ul>
			</div>
		</div>
		<div class="col-12">
	...
	<div class="row">
		<form class="form">
			<div class="col-12">
				<div class="col_in">
					...
					<div class="content">
						...
						<dl>
							<dt><p>支店名<span class="must">必須</span></p></dt>
							<dd>
								<div class="form_block"><input type="text" name="" value="新宿支店"></div>
							</dd>
						</dl>
						<dl>
						...
						<dl>
							<dt><p>支店Pass</p></dt>
							<dd>
								<div class="form_block"><input type="text" name="" value="支店Pass"></div>
							</dd>
						</dl>
					</div>
				</div>
			...
			<div class="col-12">
				<div class="col_in">
				<div class="heading2">「新宿支店」を削除</div>
					<div class="content">
	...
	<div id="pan">
		<ul>
			<li><a href="/agency/index_forsalon.php"><span>代理店一覧</span></a></li>
			<li><a href="/agency/view_forsalon.php"><span>株式会社代理店AAAAA</span></a></li>
			<li><a href="/agency/branch/index_forsalon.php"><span>支店一覧</span></a></li>
			<li><a href="/agency/branch/view_forsalon.php"><span>新宿支店</span></a></li>
		</ul>
	</div>
</main>
	...
	<nav>
		<div id="nav">
			<ul class="s_list">
				...
				<li class="st active"><a href="/agency/index_forsalon.php"><span class="material-symbols-outlined">storefront</span>代理店一覧<i></i></a>
				<ul>
					<li class="active"><a href="/agency/view_forsalon.php">代理店AAAAAAAAAA<i></i></a>
					<ul>
						<li class="active"><a href="/agency/branch/index_forsalon.php">支店一覧</a></li>
					</ul></li>
